...
module.exports.getJupiter = function Jupiter() {
    const jupiter = {
        image:'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Jupiter_OPAL_2024.png/435px-Jupiter_OPAL_2024.png',
...
module.exports.getMeteorite = function Meteorites() {
    const meteorites = {
        ...
        def:"When meteoroids — small rocks or particles from space — enter Earth’s atmosphere at high speeds, they burn up due to friction, creating bright streaks of light known as meteors or “shooting stars.” If any part of the meteoroid survives its fiery passage and lands on the ground, it’s called a meteorite. Meteor showers occur when Earth passes through the debris trail of a comet, causing dozens or even hundreds of meteors to streak through the sky each hour. These cosmic events offer both scientific insights and breathtaking views for skywatchers."
    }
